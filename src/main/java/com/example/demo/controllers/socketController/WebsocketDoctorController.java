...
@Controller
@RequestMapping
public class WebsocketDoctorController {

    @MessageMapping("/doctor/upstream") // ** Luong upstream danh cho patient => /app/patient
    @SendTo("/topic/doctor/notification") // ** Luong DownnStream phan hoi cho topic patient
    public String alert() {
        return "";
    }
