package com.example.demo.controllers.renderController.doctor;
...
@RestController("DoctorPageRender")
@RequestMapping("/doctor")
public class RenderPageDoctor {
    @Autowired
    private AccountService accountService;
    // ** Route tra ve MetaData cho dashboard chung cua Role Admin
    @GetMapping(value = "/render-doctor-page", produces = MimeTypeUtils.APPLICATION_JSON_VALUE)
